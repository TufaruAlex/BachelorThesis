    ...
    internal static class ProcessorUtil
    {
        ...
        public static PropertyProcessor CreateAttributeProcessor(InspectorProperty property, Attribute attribute)
        {
            ...
            foreach (var t in cacheAttributeProcessorTypes)
            {
                ...
                {
                    var a = t.GetCustomAttributes(typeof(CustomAttributeProcessorAttribute), false)[0] as CustomAttributeProcessorAttribute;
        ...
        public static PropertyGroupProcessor CreateGroupProcessor(InspectorPropertyGroup group, SerializedObject serializedObject, PropertyGroupAttribute attribute)
        {
            ...
            foreach (var t in cacheGroupProcessorTypes)
            {
                ...
                {
                    var a = t.GetCustomAttributes(typeof(CustomGroupProcessorAttribute), false)[0] as CustomGroupProcessorAttribute;
